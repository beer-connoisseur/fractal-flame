...
func TestNewPolarTransformation(t *testing.T) {
	wantName := "polar"
	tests := []struct {
		name   string
		weight float64
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := NewPolarTransformation(tt.weight)
...
func TestPolarTransformation_Apply(t *testing.T) {
	tests := []struct {
		name  string
		x     float64
		y     float64
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			transformation := NewPolarTransformation(1.0)
