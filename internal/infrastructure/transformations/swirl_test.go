...
func TestNewSwirlTransformation(t *testing.T) {
	wantName := "swirl"
	tests := []struct {
		name   string
		weight float64
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := NewSwirlTransformation(tt.weight)
...
func TestSwirlTransformation_Apply(t *testing.T) {
	tests := []struct {
		name  string
		x     float64
		y     float64
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			transformation := NewSwirlTransformation(1.0)
