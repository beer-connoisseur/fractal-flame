...
func TestHeartTransformation_Apply(t *testing.T) {
	tests := []struct {
		name  string
		x     float64
		y     float64
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			transformation := NewHeartTransformation(1.0)
...
func TestNewHeartTransformation(t *testing.T) {
	wantName := "heart"
	tests := []struct {
		name   string
		weight float64
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := NewHeartTransformation(tt.weight)
