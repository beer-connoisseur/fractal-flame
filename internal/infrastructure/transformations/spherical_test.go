...
func TestNewSphericalTransformation(t *testing.T) {
	wantName := "spherical"
	tests := []struct {
		name   string
		weight float64
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := NewSphericalTransformation(tt.weight)
...
func TestSphericalTransformation_Apply(t *testing.T) {
	tests := []struct {
		name  string
		x     float64
		y     float64
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			transformation := NewSphericalTransformation(1.0)
